...
EXTENSION_NAMES="goal plan lsp ast-grep hashline request rg todo promptline-editor"
...
Scopes:
  all               Nine extensions and every pi-extensions-*.json theme (default)
  extensions        goal, plan, lsp, ast-grep, hashline, request, rg, todo, and promptline-editor
