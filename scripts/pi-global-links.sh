...
EXTENSION_NAMES="goal plan lsp request rg todo promptline-editor"
...
Scopes:
  all               Seven extensions and every pi-extensions-*.json theme (default)
  extensions        goal, plan, lsp, request, rg, todo, and promptline-editor
