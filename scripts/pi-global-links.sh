...
EXTENSION_NAMES="goal plan lsp ast-grep hashline request rg todo jaron diffreport"
...
Scopes:
  ...
  extensions        goal, plan, lsp, ast-grep, hashline, request, rg, todo, jaron, and diffreport
