...
EXTENSION_NAMES="goal plan lsp ast-grep request rg todo promptline-editor"
...
Scopes:
  all               Eight extensions and every pi-extensions-*.json theme (default)
  extensions        goal, plan, lsp, ast-grep, request, rg, todo, and promptline-editor
