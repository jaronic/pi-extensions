...
export const TODO_PROMPT_GUIDELINES = [
  "Create a Todo board before non-trivial work with three or more independent steps, whenever the user provides a list, or when the user explicitly requests Todo tracking; skip it for one-step work and pure answers.",
  ...
  "Use concise actionable task text describing what must be accomplished. Initialize before work and append newly discovered or newly requested scope immediately.",
  ...
  "When Plan is active, use update_plan_step instead. Do not create or mutate a duplicate Todo execution ledger.",
