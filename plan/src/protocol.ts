...
export const PLAN_STATE_TYPE = "plan-state-v3";
export const LEGACY_PLAN_STATE_TYPES = ["plan-state-v1", "plan-state-v2"] as const;
export const PLAN_CONTROL_TYPE = "plan-control-v1";
export const PLAN_TOOL_NAMES = ["submit_plan", "report_plan_blocked", "request_plan_choice", "answer_plan_choice", "update_plan_step"] as const;
